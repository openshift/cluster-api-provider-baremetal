...
func (m *MockRemediationManagerInterface) DeleteNode(ctx context.Context, node *v1.Node) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteNode", ctx, node)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (mr *MockRemediationManagerInterfaceMockRecorder) DeleteNode(ctx, node interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteNode", reflect.TypeOf((*MockRemediationManagerInterface)(nil).DeleteNode), ctx, node)
}
...
func (m *MockRemediationManagerInterface) GetNode(ctx context.Context) (*v1.Node, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetNode", ctx)
...
func (mr *MockRemediationManagerInterfaceMockRecorder) GetNode(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetNode", reflect.TypeOf((*MockRemediationManagerInterface)(nil).GetNode), ctx)
}
...
func (mr *MockRemediationManagerInterfaceMockRecorder) UpdateNode(ctx, node interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateNode", reflect.TypeOf((*MockRemediationManagerInterface)(nil).UpdateNode), ctx, node)
}
